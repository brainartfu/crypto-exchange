    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card border-left border-primary">
                <div class="card-body">
                    <span class="font-weight-bold"><?php echo translate('Note'); ?> : </span> <code class="text-warning"><?php echo translate('Image of this page will be in same for forgot password pages.'); ?></code>
                </div>
            </div>
        </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp1\htdocs\resources\views\admin\site_contents\login.blade.php ENDPATH**/ ?>