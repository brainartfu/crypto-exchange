...
<?php $__env->startSection('title'); ?>
   <?php echo translate('Create Page'); ?>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('breadcrumb'); ?>
 <section class="section">
    <div class="section-header d-flex justify-content-between">
        <h1><?php echo translate('Create Page'); ?></h1>
         ...
         <div class="card-body">
            ...
            <form action="<?php echo e(route('admin.page.store')); ?>" method="POST" enctype="multipart/form-data">
               ...
               <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="inp-name" name="title"  placeholder="<?php echo e(__('Enter Title')); ?>" value="" required>
               </div>
               <div class="form-group">
                  <label for="description"><?php echo e(__('Description')); ?></label>
                  <textarea id="area1" class="form-control summernote" name="details" placeholder="<?php echo e(__('Description')); ?>"></textarea>
              </div>
...
<!--Row-->
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp1\htdocs\resources\views\admin\page\create.blade.php ENDPATH**/ ?>