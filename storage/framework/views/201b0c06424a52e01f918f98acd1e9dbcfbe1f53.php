<aside id="sidebar-wrapper">
  ...
  <ul class="sidebar-menu mb-5">
      ...
      <?php if(access('transactions')): ?>
      <li class="nav-item <?php echo e(menu('admin.notifications')); ?>">
        <a href="<?php echo e(route('admin.notifications')); ?>" class="nav-link"><i class="fas fa-bell"></i><span><?php echo translate('Send Notification'); ?></span></a>
      </li>
      <?php endif; ?>

      <li class="menu-header"><?php echo translate('Manage'); ?></li>
      <li class="nav-item <?php echo e(menu(['admin.user.best_seller'])); ?>">
        <a href="<?php echo e(route('admin.user.best_seller')); ?>" class="nav-link"><i class="fas fa-users"></i><span><?php echo translate('Best Sellers'); ?></span></a>
      </li>
      ...
      <li class="nav-item <?php echo e(menu('admin.review.index')); ?>">
        <a href="<?php echo e(route('admin.review.index')); ?>" class="nav-link"> <i class="fas fa-th"></i><span><?php echo translate('Reviews'); ?></span></a>
      </li>
      ...
      <?php endif; ?>
      <?php if(access('manage page') || access('menu builder') || access('site contents') ||  access('manage blog-category') || access('seo settings')): ?>
      <li class="nav-item dropdown <?php echo e(menu(['admin.front*','admin.page*','admin.frontend*','admin.bcategory*','admin.seo-setting*'])); ?>">
      ...
      <?php if(access('manage blog')): ?>
      <li class="nav-item dropdown <?php echo e(menu(['admin.blog*'])); ?>">
        <a href="#" class="nav-link has-dropdown"><i class="fas fa-blog"></i> <span><?php echo translate('Manage Blog'); ?></span></a>
        <ul class="dropdown-menu">
        

          
          <li class="<?php echo e(menu(['admin.blog.index','admin.blog.create','admin.blog.edit'])); ?>"><a class="nav-link" href="<?php echo e(route('admin.blog.index')); ?>"><?php echo translate('Admin Blog'); ?></a></li>
          <li class="<?php echo e(menu('admin.blog.user*')); ?>"><a class="nav-link" href="<?php echo e(route('admin.blog.user.index')); ?>"><?php echo translate('User Blog'); ?></a></li>
...
</aside><?php /**PATH C:\xampp1\htdocs\resources\views\admin\partials\sidebar.blade.php ENDPATH**/ ?>