                    ...
                    <form action="<?php echo e(route('admin.currency.update',$currency->id)); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <?php if($currency->type == 2): ?>
                                <div class="input-group mb-3 col-xl-6">
                                    ...
                                    <div class="input-group has_append">
                                        <input class="form-control" type="number" name="deposit_charge" placeholder="0" value="<?php echo e(@$currency->charges->deposit_charge); ?>" step="any" required>
                                        <div class="input-group-append">
                                ...
                                <div class="input-group mb-3 col-xl-6">
                                    ...
                                    <div class="input-group has_append">
                                        <input class="form-control" type="number" name="withdraw_charge" placeholder="0" value="<?php echo e(@$currency->charges->withdraw_charge); ?>" step="any" required>
                                        <div class="input-group-append">
                                            <div class="input-group-text"><span>%</span>
                                            </div>
                                        </div>
                                ...
                                <div class="input-group mb-3 col-xl-6">
                                    ...
                                    <div class="input-group has_append">
                                        <input class="form-control" type="number" name="withdraw_limit_min" placeholder="0" value="<?php echo e(@$currency->charges->withdraw_limit_min); ?>" step="any" required>
                                        <div class="input-group-append">
                                ...
                                <div class="input-group mb-3 col-xl-6">
                                    ...
                                    <div class="input-group has_append">
                                        <input class="form-control" type="number" name="withdraw_limit_max" placeholder="0" value="<?php echo e(@$currency->charges->withdraw_limit_max); ?>" step="any" required>
                                        <div class="input-group-append">
                                            <div class="input-group-text"><span><?php echo e($currency->code); ?></span>
                                            </div>
                                        </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp1\htdocs\resources\views\admin\currency\edit.blade.php ENDPATH**/ ?>