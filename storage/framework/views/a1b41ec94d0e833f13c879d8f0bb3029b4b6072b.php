            ...
            <?php if($trade->offer->type == 'sell'): ?>
                <?php if($trade->trader_id == auth()->id()): ?>
                    <?php if($trade->status == 1 && $trade->status != 4): ?> 
                        <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#disputeModal"  class="btn btn--base btn-sm"><?php echo translate('Dispute'); ?></a>
                    <?php else: ?>
                        <a href="javascript:void(0)" class="btn btn--base disabled btn-sm"><?php echo translate('Dispute'); ?></a>
                    <?php endif; ?>
...
<?php /**PATH C:\xampp1\htdocs\resources\views\user\trade\chat.blade.php ENDPATH**/ ?>