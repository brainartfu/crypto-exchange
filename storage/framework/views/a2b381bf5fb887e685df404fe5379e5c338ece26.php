...
<?php $__env->startSection('breadcrumb'); ?>
 <section class="section">
    <div class="section-header  d-flex justify-content-between">
        <h1><?php echo translate('Blog Details'); ?></h1>
        <a href="<?php echo e(url()->previous()); ?>" class="btn btn-primary"><i class="fas fa-backward"></i> <?php echo translate('Back'); ?></a>
    </div>
</section>
<?php $__env->stopSection(); ?>
   ...
   <div class="col-md-12">
      ...
      <div class="card mb-4">
         <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h6 class="m-0 font-weight-bold text-primary"><?php echo e(__('Blog Detail Form')); ?></h6>
         </div>
         <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control  mb-3"  name="status" required>
                            ...
                            <option value="2" <?php echo e($blog->status == 2 ? 'selected':''); ?>><?php echo e(translate('Pending')); ?></option>
...
<!--Row-->
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp1\htdocs\resources\views\admin\blog\user_blog_edit.blade.php ENDPATH**/ ?>