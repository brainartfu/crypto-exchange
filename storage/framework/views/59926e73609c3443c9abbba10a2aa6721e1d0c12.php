...
<section class="trade-request-section pb-100 pt-100">
    <div class="container">
        <div class="row gy-4">
                        ...
                        <div class="about-offer-wrap">
                            ...
                            <div class="d-flex flex-wrap">
                                ...
                                <?php if($offer->type == 'buy'): ?>
                                    <div class="about-offer-item">
                                        <span class="title"><?php echo e(__($gs->title)); ?> <?php echo translate('Fee'); ?></span>
                                        <div class="info">
                ...
                <div class="about-offer">
                    ...
                    <div class="about-offer-area border rounded">
                        <div class="cmn--media ms-0">
                            ...
                            <div class="subtitle">
                                <h5 class="m-0"><a href="<?php echo e(route('profile', ['id' => $offer->user->id])); ?>"> <?php echo e($offer->user->name); ?> </a> </h5>
                                <span class="m-0"><?php echo translate('Total Completed Trade : '); ?> <?php echo e($offer->user->completedTrade()); ?></span>
                            </div>
                        </div>
            ...
            <div class="col-lg-6">
                <div class="about-offer">
                    <h4 class="title mb-3 pt-3"><?php echo translate('Trade Instruction'); ?></h4>
                    <div class="about-offer-area border rounded">
...
<section class="trade-request-section pb-100 pt-100">
    <div class="container">
        <div class="row gy-4">
            <div class="col-lg-12">
                <div class="create-trade-request-wrapper  border">
                <h6 class="text-center"><?php echo translate('Please submit your KYC info for further trade.'); ?> <a class="text--base" href="<?php echo e(route('user.kyc.form')); ?>"><?php echo translate('Submit.'); ?></a></h6>
                </div>
            </div>
        </div>
    </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp1\htdocs\resources\views\frontend\create_trade.blade.php ENDPATH**/ ?>