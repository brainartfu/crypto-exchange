                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $loginInfo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td data-label="<?php echo translate('Sl'); ?>"><?php echo e($key + $loginInfo->firstItem()); ?></td>
                                     <td data-label="<?php echo translate('Merchant'); ?>">
                                       <?php echo e($item->merchant->email); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp1\htdocs\resources\views\admin\merchant\login_info.blade.php ENDPATH**/ ?>