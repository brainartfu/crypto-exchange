...
<?php $__env->startSection('title'); ?>
   <?php echo translate('KYC Info'); ?>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('breadcrumb'); ?>
 <section class="section">
    <div class="section-header justify-content-between">
        <h1><?php echo translate('KYC Info'); ?></h1>
        <form action="">
            <div class="row">
                <div class="col-md-6">
                ...
                <div class="table-responsive">
                    <table class="table table-striped">
                        <tr>
                            ...
                            <th><?php echo app('translator')->get('KYC Status'); ?></th>
                            ...
                            <tr>
                                <td data-label="<?php echo app('translator')->get('Sl'); ?>"><?php echo e($key + $userKycInfo->firstItem()); ?></td>
                                 ...
                                 <td data-label="<?php echo app('translator')->get('Details'); ?>">
                                     <a class="btn btn-info details" href="<?php echo e(route('admin.kyc.details',$info->id)); ?>"><?php echo app('translator')->get('Details'); ?></a>
                                 </td>
                                 <?php else: ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp1\htdocs\resources\views\admin\kyc\kyc_info.blade.php ENDPATH**/ ?>