              ...
              <li class="ms-auto position-relative">
                  ...
                  <div class="user-toggle-menu">
                      <ul>
                        ...
                        <li><a class="dropdown-item" href="<?php echo e(route('user.two.step')); ?>"><i class="fas fa-lock"></i><?php echo translate('Two Step Verify'); ?></a></li>
...
</div><?php /**PATH C:\xampp1\htdocs\resources\views\user\partials\header.blade.php ENDPATH**/ ?>