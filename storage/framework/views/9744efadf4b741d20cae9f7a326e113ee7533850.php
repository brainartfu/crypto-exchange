   ...
   <div class="col-md-12">
      ...
      <div class="card mb-4">
         ...
         <div class="card-body">
            ...
            <form action="<?php echo e(route('admin.blog.store')); ?>" enctype="multipart/form-data" method="POST">
                <?php echo csrf_field(); ?>
                <div class="col-md-12 ShowImage mb-3  text-center">
                    <img src="<?php echo e(getPhoto('')); ?>" class="img-fluid" alt="image" width="400">
                 </div>
...
<!--Row-->
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp1\htdocs\resources\views\admin\blog\create.blade.php ENDPATH**/ ?>