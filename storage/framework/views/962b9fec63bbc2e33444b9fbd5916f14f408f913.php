                ...
                <div class="dashboard-card">
                    ...
                    <div class="dashboard-card__content">
                        <div class="deposit-btn-grp">
                            ...
                            <a href="javascript:void(0)" data-code="<?php echo e($item->curr->code); ?>" data-charge="<?php echo e(@$item->curr->charges->deposit_charge); ?>" class="btn btn-sm btn--primary deposit"><?php echo translate('Get Deposit Address'); ?></a>

                            <a href="<?php echo e(route('user.deposit.address.existing',$item->curr->code)); ?>" class="btn btn-sm btn--info btn-block"><?php echo translate('Existing Addresses'); ?></a>
                            <?php endif; ?>
...
<?php $__env->startPush('script'); ?>
    <script>
        ...
        $('.deposit').on('click', function () { 
            ...
            $('.charge').text($(this).data('charge')+'% '+'<?php echo translate(' deposit charge will be reduced from the amount.'); ?>')
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp1\htdocs\resources\views\user\wallets.blade.php ENDPATH**/ ?>