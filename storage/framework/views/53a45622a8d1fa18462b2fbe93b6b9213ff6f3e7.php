        ...
        <div class="accounts-inner__wrapper bg--section">
            <div class="accounts-left">
                <div class="accounts-left-content">
                    ...
                    <div class="section-header">
                        ...
                        <h3 class="section-header__title"><?php echo translate('Password Reset Code'); ?></h3>
                        <p>
                            <?php echo translate('Enter the reset code that we have sent to your email.'); ?>
                        </p>
                    </div>
                    <form class="row gy-4" action="" method="post">
                        <?php echo csrf_field(); ?>
                        <div class="col-sm-12 form-group">
                            <label class="form--label" for="email"><?php echo translate('Reset Code'); ?></label>
            ...
            <div class="accounts-right bg--blue">
                ...
                <div class="section-header text-center text-white mb-0">
                    ...
                    <h3 class="section-header__title"><?php echo translate('Password Reset Code ?'); ?></h3>
                    <p>
                        <?php echo translate('Password reset code is to verify that it\'s you who is actually performing the action.'); ?>
                    </p>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp1\htdocs\resources\views\user\auth\verify_code.blade.php ENDPATH**/ ?>