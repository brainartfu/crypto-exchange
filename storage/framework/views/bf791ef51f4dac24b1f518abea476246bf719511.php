   ...
   <div class="col-md-12">
      ...
      <div class="card mb-4">
         ...
         <div class="card-body">
            ...
            <form action="<?php echo e(route('user.blog.update',$blog->id)); ?>" enctype="multipart/form-data" method="POST">
                <?php echo csrf_field(); ?>
...
<!--Row-->
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp1\htdocs\resources\views\user\blog\edit.blade.php ENDPATH**/ ?>