...
<?php $__env->startSection('title'); ?>
   <?php echo translate('Email Template'); ?>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('breadcrumb'); ?>
 <section class="section">
    <div class="section-header justify-content-between">
        <h1><?php echo translate('Edit Email Template'); ?></h1>
        <a class="btn btn-primary" href="<?php echo e(route('admin.mail.index')); ?>"><i class="fas fa-backward"></i> <?php echo translate('Back'); ?></a>
    </div>
</section>
<?php $__env->stopSection(); ?>
    ...
    <div class="col-lg-10">
       <div class="card mb-4">
          <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
             <h6 class="m-0 font-weight-bold text-primary"><?php echo e(__('Edit Email Template Form')); ?></h6>
          </div>
          <div class="card-body">
           ...
           <form id="geniusformUpdate" action="<?php echo e(route('admin.mail.update',$data->id)); ?>" method="POST" enctype="multipart/form-data">
              <?php echo csrf_field(); ?>
             ...
             <div class="row justify-content-center mb-3" >
                ...
                <div class="form-group">
                   ...
                   <textarea id="area1" class="form-control summernote" name="email_body" placeholder="<?php echo e(__('Email Body')); ?>"><?php echo e($data->email_body); ?></textarea>
                </div>
                <div class="row">
                   <div class="col-lg-4">
                      <div class="left-area">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp1\htdocs\resources\views\admin\email\edit.blade.php ENDPATH**/ ?>