...
<?php $__env->startSection('breadcrumb'); ?>
 <section class="section">
    <div class="section-header d-flex flex-wrap justify-content-between">
      <h1 class="mb-1 mr-auto"><?php echo translate('Crypto Currencies'); ?></h1>
      ...
      <div class="card card-primary">
        ...
        <div class="card-body">
          <ul class="list-group mb-3">
            ...
            <li class="list-group-item d-flex justify-content-between"><?php echo translate('Rate '); ?> <?php echo e('1 '.$curr->code); ?> =
              <span class="font-weight-bold"><?php echo e(amount($curr->rate,3)); ?> <?php echo e($gs->curr_code); ?></span>
            </li>
          </ul>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp1\htdocs\resources\views\admin\currency\crypto_currencies.blade.php ENDPATH**/ ?>