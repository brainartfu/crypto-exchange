    ...
    <div class="dashboard--content-item">
        <div class="create-offer-wrapper">
            <div class="create-offer-body">
                <h4 class="text-center"><?php echo translate('Please submit your KYC info to create further offer'); ?></h4>
            </div>
        </div>
    </div>
<?php else: ?>
                ...
                <form class="create-offer-form" action="" method="POST">
                    ...
                    <fieldset>
                        <div class="row gy-4">
                            ...
                            <div class="col-xxl-6">
                                <h5 class="text--base mb-4 mt-0"><?php echo translate('What you would like to do ?'); ?></h5>
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="transaction-crypto form-check-label" for="sell-crypto">
                                            ...
                                            <div>
                                                ...
                                                <p>
                                                    <?php echo translate('Your offer will be listed for the buy page'); ?>
                                                </p>
                                            </div>
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        ...
                                        <label class="transaction-crypto form-check-label" for="buy-crypto">
                                            ...
                                            <div>
                                                ...
                                                <p>
                                                    <?php echo translate('Your offer will be listed for the sell page'); ?>
                                                </p>
                                            </div>
                                        </label>
                                    </div>
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="transaction-crypto form-check-label" for="fixed-price">
                                            ...
                                            <div>
                                                ...
                                                <p>
                                                    <?php echo translate('Your offer price will locked when you create
                                                    it and won\'t change.'); ?>
                                                </p>
                                            </div>
                                        </label>
                            ...
                            <div class="col-sm-12">
                                <div class="text-end">
                                    <button type="submit" class="cmn--btn rounded next-step"><i
                                            class="fas fa-plus"></i> <?php echo translate('Create
                                            New Offer'); ?></button>
                                </div>
                            </div>
                        </div>
    ...
    <div class="dashboard--content-item">
        <div class="create-offer-wrapper">
            <div class="create-offer-body">
                <h4 class="text-center"><?php echo translate('Sorry!! You must complete more trade to create further offer.'); ?></h4>
            </div>
        </div>
    </div>
    <?php endif; ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp1\htdocs\resources\views\user\offer\create.blade.php ENDPATH**/ ?>