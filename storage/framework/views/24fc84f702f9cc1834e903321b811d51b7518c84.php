                ...
                <div class="accounts-left-content mw-100">
                    ...
                    <form class="row g-4" action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-sm-6 form-group">
                            <label class="form--label"><?php echo translate('Name'); ?></label>
                            <input type="text" class="form-control" name="name" placeholder="<?php echo translate('Enter name'); ?>" required value="<?php echo e(old('name')); ?>">
                        </div>
                        <div class="col-sm-6 form-group">
                        ...
                        <div class="col-sm-6 form-group">
                             <label class="form--label"><?php echo translate('Phone No.'); ?></label>
                            <input type="hidden" name="dial_code">
                            <div class="input-group">
                                <span class="input-group-text d_code"></span>
                                <input type="text" name="phone"  class="form-control" placeholder="<?php echo translate('Phone No.'); ?>" required value="<?php echo e(old('phone')); ?>">
                            </div>
                        </div>
    
                        <div class="col-sm-12 form-group">
                            <label class="form--label"><?php echo translate('Address'); ?></label>
                            <input type="text" name="address" value="<?php echo e(old('address')); ?>" class="form-control" placeholder="<?php echo translate('Address'); ?>" required>
                        </div>
						<div class="col-sm-12 form-group">
                            <label class="form--label"><?php echo translate('Profile Photo'); ?></label>
                        ...
                        <div class="col-sm-6 form-group">
                            ...
                            <div class="input-group input-group-flat">
                                <input type="password" name="password" class="form-control"  placeholder="<?php echo translate('Password'); ?>"  autocomplete="off" required>
                            </div>
                        </div>
                        <div class="col-sm-6 form-group">
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp1\htdocs\resources\views/user/auth/register.blade.php ENDPATH**/ ?>