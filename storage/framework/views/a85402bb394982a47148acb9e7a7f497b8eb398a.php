...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-12 mt-2">
                          <a href="<?php echo e(route('user.forgot.password')); ?>" class="text--base"><?php echo translate('Forget Password?'); ?></a>
                        </div>
                        <div class="col-sm-12">
                            <button type="submit" class="cmn--btn"><?php echo translate('Sign In'); ?></button>
                        </div>
                        <div class="col-sm-12">
                            <?php echo translate('Not registered yet ?'); ?> <a href="<?php echo e(route('user.register')); ?>" class="text--base"><?php echo translate('Create an Account'); ?></a>
                        </div>
                    </form>
                </div>
            </div>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp1\htdocs\resources\views\user\auth\login.blade.php ENDPATH**/ ?>