        ...
        <div class="modal-content">
            <form method="POST" action="<?php echo e(route('user.offer.status')); ?>">
                ...
                <div class="modal-body p-4 text-center">
                    <h5><?php echo translate('Are you sure about changing status ?'); ?></h5>
                </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp1\htdocs\resources\views\user\offer\index.blade.php ENDPATH**/ ?>