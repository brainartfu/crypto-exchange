        ...
        <div class="accounts-inner__wrapper bg--section">
            ...
            <div class="accounts-right bg--blue">
                ...
                <div class="section-header text-center text-white mb-0">
                    ...
                    <p>
                        <?php echo translate('Email verification is needed to verify whether its you or scam email.'); ?>
                    </p>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp1\htdocs\resources\views\user\email_verify\verify_code.blade.php ENDPATH**/ ?>