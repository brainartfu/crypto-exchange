...
<?php endif; ?>
<li class="list-group-item d-flex justify-content-between"><?php echo translate('Date'); ?><span><?php echo e(dateFormat($transaction->created_at,'d M y')); ?></span></li><?php /**PATH C:\xampp1\htdocs\resources\views\user\trx_details.blade.php ENDPATH**/ ?>