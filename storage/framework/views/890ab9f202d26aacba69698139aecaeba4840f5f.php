    ...
    <div class="container">
        <div class="ctas__wrapper">
            ...
            <div class="ctas-button">
                ...
                <h2 class="title"><?php echo translate('Register'); ?></h2>
                <div class="text">
                   <?php echo translate('Don\'t have an account ? Register with us.'); ?>
                    </spandiv>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="footer-wrapper">
                ...
                <div class="footer-links mobile-second-item">
                    ...
                    <ul>
                        <li>
                            <a href="<?php echo e(route('offer.list',['type' => 'buy'])); ?>"><?php echo app('translator')->get('Buy Crypto'); ?></a>
                        </li>
                        <li>
                            <a href="<?php echo e(route('offer.list',['type' => 'sell'])); ?>"><?php echo app('translator')->get('Sell Crypto'); ?></a>
                        </li>
                        <li>
...
<!-- Footer Section --><?php /**PATH C:\xampp1\htdocs\resources\views\frontend\partials\footer.blade.php ENDPATH**/ ?>