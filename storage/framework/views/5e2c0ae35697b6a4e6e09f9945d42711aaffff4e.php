...
<?php $__env->startSection('title'); ?>
   <?php echo translate('Manage Merchant'); ?>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('breadcrumb'); ?>
 <section class="section">
    <div class="section-header justify-content-between">
        <h1> <?php echo translate('Manage Merchant'); ?></h1>
        <form action="">
            <div class="row">
                <div class="col-md-6">
                    <select class="form-control" id="" onChange="window.location.href=this.value">
                        <option value="<?php echo e(url('admin/manage-merchants/'.'?status=all')); ?>" <?php echo e(request('status') == 'all'?'selected':''); ?>><?php echo translate('All'); ?></option>
                        <option value="<?php echo e(url('admin/manage-merchants/'.'?status=active')); ?>" <?php echo e(request('status') == 'active'?'selected':''); ?>><?php echo translate('Active'); ?></option>
                        <option value="<?php echo e(url('admin/manage-merchants/'.'?status=banned')); ?>" <?php echo e(request('status') == 'banned'?'selected':''); ?>><?php echo translate('Banned'); ?></option>
                    </select>
                </div>
                <div class="col-md-6">
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td data-label="<?php echo translate('Sl'); ?>"><?php echo e($key + $users->firstItem()); ?></td>
                                 ...
                                 <?php if(access('edit merchant')): ?>
                                 <td data-label="<?php echo translate('Action'); ?>">
                                     <a class="btn btn-primary details" href="<?php echo e(route('admin.merchant.details',$user->id)); ?>"><?php echo translate('Details'); ?></a>
                                 </td>
                                 <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp1\htdocs\resources\views\admin\merchant\index.blade.php ENDPATH**/ ?>