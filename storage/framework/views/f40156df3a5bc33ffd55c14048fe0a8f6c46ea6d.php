...
<div class="row">
  <div class="col-lg-12">
    ...
    <div class="card-header d-flex justify-content-end">
      <a href="<?php echo e(route('user.blog.create')); ?>" class="btn btn-primary"><i class="fas fa-plus"></i> <?php echo translate('Add New'); ?></a>
    </div>
      ...
      <table class="table align-items-center table-striped" style="border-top: none;">
          ...
          <tr>
               ...
               <td data-label="<?php echo e(__('Status')); ?>">
                  ...
                  <span class="badge badge-info"> <?php echo translate('Pending'); ?> </span>
                  <?php else: ?>
                  <span class="badge badge-danger"> <?php echo translate('Inactive'); ?> </span>
                  <?php endif; ?>
               </td>

               <td data-label="<?php echo e(__('Action')); ?>">
                  <a href="<?php echo e(route('user.blog.edit',$item->id)); ?>" class="btn btn-primary  btn-sm edit mb-1" data-toggle="tooltip" title="<?php echo translate('Edit'); ?>"><i class="fas fa-edit"></i></a>

                  <a href="javascript:void(0)" class="btn btn-danger  btn-sm remove mb-1" data-route="<?php echo e(route('user.blog.destroy',$item)); ?>" data-toggle="tooltip" title="<?php echo translate('Delete'); ?>"><i class="fas fa-trash"></i></a>
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp1\htdocs\resources\views\user\blog\index.blade.php ENDPATH**/ ?>