                   ...
                   <div class="card-body">
                    <div class="chatbox__list__wrapper">
                        <div class="d-flex justify-content-between py-4 border-bottom border--dark">
                            <h4 class="mt-2"><a href="javascript:void(0)"><?php echo translate('Tickets'); ?></a></h4>
                            <button class="btn btn--base btn-sm shadow-none" data-bs-toggle="modal" data-bs-target="#modelId"><i class="fas fa-plus me-2"></i> <?php echo translate('Open a Ticket'); ?></button>
                        </div>
                                ...
                                <div class="chat__msg">
                                    <div class="chat__msg-header py-2 border-bottom">
                                        <div class="post__creator align-items-center">
                                            ...
                                            <div class="post__creator-content">
                                                <h4 class="name d-inline-block"><?php echo translate('Ticket Number : #'); ?><?php echo e(request('messages')); ?></h4>
                                            </div>
                ...
                <?php echo csrf_field(); ?>
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title"><?php echo translate('Open a ticket'); ?></h5> 
                        </div>
                        <div class="modal-body">
                            <div class="form-group">
                                <label class="mb-2"><?php echo translate('Subject'); ?></label>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp1\htdocs\resources\views\user\ticket\index.blade.php ENDPATH**/ ?>