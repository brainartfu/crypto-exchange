                    ...
                    <form action="<?php echo e(route('admin.frontend.content.update',$section->id)); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <textarea name="sub_heading" class="form-control" required><?php echo e(@$section->content->sub_heading); ?></textarea>
                            </div>
                            <div class="form-group col-md-12">
                                <label for=""><?php echo translate('Button Name'); ?></label>
                                <input type="text" name="button_name" class="form-control" placeholder="<?php echo translate('Button name'); ?>" value="<?php echo e(@$section->content->button_name); ?>" required>
                            </div>
                            <div class="form-group col-md-12">
                                <label for=""><?php echo translate('Button URL'); ?></label>
                                <input type="text" name="button_url" class="form-control" placeholder="<?php echo translate('Button URL'); ?>" value="<?php echo e(@$section->content->button_url); ?>" required>
                            </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    <tr>
                                        ...
                                        <th><?php echo translate('Counter'); ?></th>
                                    ...
                                    <?php $__empty_1 = true; $__currentLoopData = $section->sub_content; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            ...
                                            <td data-label="<?php echo translate('Counter'); ?>"><?php echo e($info->counter); ?></td>
                    ...
                    <form action="<?php echo e(route('admin.frontend.sub-content.update',$section->id)); ?>" method="POST">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <label><?php echo translate('Counter'); ?></label>
                                    <input class="form-control" type="text" name="counter" required>
                                </div>
                            </div>
...
<?php $__env->startPush('script'); ?>
    <script>
        ...
        $('.details').on('click',function () { 
            ...
            $('#edit').find('textarea[name=counter]').val(data.counter)
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp1\htdocs\resources\views\admin\site_contents\counter.blade.php ENDPATH**/ ?>